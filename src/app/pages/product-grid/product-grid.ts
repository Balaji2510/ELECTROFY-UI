...
@Component({
  ...
  imports: [ProductCard, MatSidenavModule, MatNavList, MatListItem, MatListItemTitle, RouterLink, TitleCasePipe],
  template: `
  <mat-sidenav-container>
    ...
    <mat-sidenav-content  class="bg-gray-100 min-h-screen p-6 h-full">
      ...
      <p class="text-base text-gray-600 mb-6">
        {{ filteredProducts().length }} {{ category().toLowerCase() === 'all' ? '' : category().toLowerCase() }} products found.
      </p>
